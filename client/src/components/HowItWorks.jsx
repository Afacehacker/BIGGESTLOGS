        ...
        <section className="py-24 px-6 bg-white/5 dark:bg-[#1e293b]/20">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-20">
                    <h2 className="text-4xl md:text-5xl font-bold mb-6">HOW IT <span className="text-primary-light">WORKS</span></h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {steps.map((step, index) => (
                        ...
                        >
                            ...
                            <div className="glass-card flex flex-col items-center text-center group h-full hover:border-primary/50">
                                ...
                                <div className="mt-6 text-primary/30 font-black text-6xl select-none">
                                    0{index + 1}
                                </div>
                            </div>
                        </motion.div>
